          ...
          <div className="space-y-4 text-muted-foreground">
            <div>
              ...
              <ul className="list-disc list-inside space-y-1 ml-4">
                ...
                <li>Corrected Nota Rel. im Hebr. to Die Nota relationis im Hebräischen.</li>
              </ul>
            </div>
            <div>
            ...
            <div>
              ...
              <ul className="list-disc list-inside space-y-1 ml-4">
                ...
                <li>Corrected “Bae (Rel.” citations to Baethgen’s Religionsgeschichte rather than “Baethgen (Reland.”</li>
                <li>Added “inscrr.” → “inscriptions” and contextual “Nor (” → “Norris (” expansions.</li>
